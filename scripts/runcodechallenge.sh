...
/usr/spark/spark-1.5.1/bin/spark-submit --class "abide.examples.CodingChallenge" --master local[4] /vagrant/scripts/CodingChallengeScala/target/scala-2.10/coding-challenge_2.10-1.0.jar
