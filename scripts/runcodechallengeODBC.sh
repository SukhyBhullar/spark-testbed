...
sudo /usr/spark/spark-1.4.0/bin/spark-submit --class "abide.examples.CodingChallengeODBC" --master local[4] /vagrant/scripts/CodingChallengeODBC/target/scala-2.10/coding-challenge_2.10-1.0.jar
